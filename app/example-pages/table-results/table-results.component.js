(function () {
    ...
    angular.module("USCBPttrn")
        .controller("tableResultsCtrl", ["$timeout","RouteService", "$location", "$anchorScroll", "$mdSidenav", '$mdBottomSheet', function ($timeout,RouteService, $location, $anchorScroll, $mdSidenav, $mdBottomSheet) {
            var vm = this;
